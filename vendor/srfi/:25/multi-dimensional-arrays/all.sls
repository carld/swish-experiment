...
;;;;;; File header: %3a25/multi-dimensional-arrays/all.sls
#!r6rs
;; Copyright 2009 Derick Eddington.  My MIT-style license is in the file named
;; LICENSE from the original collection this file is distributed with.
;;;;;; File header: %3a25/ix-ctor.scm
;;;;;; File header: %3a25/op-ctor.scm
;;;;;; File header: %3a25/array.scm
;;; array
;;; 1997 - 2001 Jussi Piitulainen
(library (srfi :25 multi-dimensional-arrays all)
  (export array:make array:array? array:vector array:index
   array:shape array-ref array-set! array:opt-args
   array:optimize array:optimize-empty array:coefficients
   array:vector-index array:shape-index array:empty-shape-index
   array:shape-vector-index array:actor-index array:0 array:1
   array:2 array:3 array:n array:maker array:indexer/vector
   array:indexer/array array:applier-to-vector
   array:applier-to-actor array:applier-to-backing-vector
   array:index/vector array:index/array array:apply-to-vector
   array:apply-to-actor array? make-array array:make-array
   shape array array-rank array-start array-end share-array
   array:share/index! array:optimize/vector
   array:optimize/actor array:shape->vector array:size
   array:make-index array:good-shape? array:good-share?
   array:unchecked-share-depth? array:check-indices
   array:check-indices.o array:check-index-vector
   array:check-index-actor array:good-indices?
   array:good-indices.o? array:good-index-vector?
   array:good-index-actor? array:good-index? array:not-in
   array:list->string array:shape-vector->string
   array:thing->string array:index-ref array:index-set!
   array:index-length array:map->string
   array:map-column->string array:grok/arguments
   array:grok/index!)
  (import (rnrs) (rnrs mutable-pairs) (rnrs r5rs)
    (srfi :23 error tricks) (srfi private include))
  (define-record-type (array-type array:make array:array?)
    (fields
      (immutable vec array:vector)
  ...
  (SRFI-23-error->R6RS
    ...
    (begin
      (define (array-ref a . xs)
        (or (array:array? a) (error "not an array"))
      ...
      (define (array-set! a x . xs)
        (or (array:array? a) (error "array-set!: not an array"))
        (let ([shape (array:shape a)])
          (if (null? xs)
    ...
    (begin
      (begin
            ...
            [(3)
             (let ([n0 (f 0 0 0)])
               (array:3
                 ...
                 (- (f 0 0 1) n0)))]
            [else
             (let ([v (do ([k 0 (+ k 1)] [v '() (cons 0 v)])
                          ((= k r) v))])
               (let ([n0 (apply f v)])
                 (apply array:n n0 (array:coefficients f n0 v v))))]))
        (define (array:optimize-empty r)
          (let ([x (make-vector (+ r 1) 0)]) (vector-set! x r -1) x))
        ...
        (define array:indexer/vector
          (let ([em (vector (lambda (x i) (+ (vector-ref x 0)))
                      (lambda (x i)
        ...
        (define array:indexer/array
          (let ([em (vector (lambda (x v i) (+ (vector-ref x 0)))
                      (lambda (x v i)
                        (+ (* (vector-ref x 0)
        ...
        (define array:applier-to-vector
          (let ([em (vector (lambda (p v) (p))
                      (lambda (p v) (p (vector-ref v 0)))
                      (lambda (p v) (p (vector-ref v 0) (vector-ref v 1)))
                      (lambda (p v)
                        (p (vector-ref v 0)
                           (vector-ref v 1)
                           (vector-ref v 2)))
                      ...
                      (lambda (p v)
                        (p (vector-ref v 0) (vector-ref v 1) (vector-ref v 2)
                      ...
                      (lambda (p v)
                        (p (vector-ref v 0) (vector-ref v 1) (vector-ref v 2)
                           (vector-ref v 3) (vector-ref v 4)
                           (vector-ref v 5) (vector-ref v 6)
                           (vector-ref v 7) (vector-ref v 8))))]
                [it (lambda (r)
                      (lambda (p v)
                        (apply p (vector-ref v 0) (vector-ref v 1)
                          (vector-ref v 2) (vector-ref v 3)
                          (vector-ref v 4) (vector-ref v 5)
        ...
        (define array:applier-to-actor
          (let ([em (vector (lambda (p a) (p)) (lambda (p a) (p (array-ref a 0)))
                      (lambda (p a) (p (array-ref a 0) (array-ref a 1)))
                      (lambda (p a)
                        (p (array-ref a 0)
                           (array-ref a 1)
                           (array-ref a 2)))
                      (lambda (p a)
                        (p (array-ref a 0)
                           ...
                           (array-ref a 3)))
                      (lambda (p a)
                        (p (array-ref a 0) (array-ref a 1) (array-ref a 2)
                           (array-ref a 3) (array-ref a 4)))
                      (lambda (p a)
                        (p (array-ref a 0) (array-ref a 1) (array-ref a 2)
                           (array-ref a 3) (array-ref a 4)
                           (array-ref a 5)))
                      (lambda (p a)
                        (p (array-ref a 0) (array-ref a 1) (array-ref a 2)
                           (array-ref a 3) (array-ref a 4) (array-ref a 5)
                           (array-ref a 6)))
                      (lambda (p a)
                        (p (array-ref a 0) (array-ref a 1) (array-ref a 2)
                           (array-ref a 3) (array-ref a 4) (array-ref a 5)
                           (array-ref a 6) (array-ref a 7)))
                      (lambda (p a)
                        (p (array-ref a 0) (array-ref a 1) (array-ref a 2)
                           (array-ref a 3) (array-ref a 4) (array-ref a 5)
                           (array-ref a 6) (array-ref a 7)
                ...
                [it (lambda (r)
                      (lambda (p a)
                        (apply a (array-ref a 0) (array-ref a 1) (array-ref a 2)
                          (array-ref a 3) (array-ref a 4) (array-ref a 5)
                          (array-ref a 6) (array-ref a 7) (array-ref a 8)
                          (array-ref a 9)
                          (do ([k r (- k 1)]
        ...
        (define array:applier-to-backing-vector
          (let ([em (vector (lambda (p ai av) (p))
                      (lambda (p ai av)
                ...
                [it (lambda (r)
                      (lambda (p ai av)
                        (apply p (vector-ref av (array:actor-index ai 0))
                          (vector-ref av (array:actor-index ai 1))
                          (vector-ref av (array:actor-index ai 2))
                          (vector-ref av (array:actor-index ai 3))
                          (vector-ref av (array:actor-index ai 4))
    ...
    (begin
      (define (array? obj) (array:array? obj))
        ...
        (let ([size (array:size shape)])
          (array:make
            (if (pair? rest)
                ...
                (make-vector size))
            (if (= size 0)
                (array:optimize-empty (vector-ref (array:shape shape) 1))
                (array:optimize
      ...
      (define (shape . bounds)
        (let ([v (list->vector bounds)])
          ...
          (let ([shp (array:make
                       ...
                       (vector 0 (quotient (vector-length v) 2) 0 2))])
            (or (array:good-shape? shp)
                (error (string-append
                         "shape: bounds are not pairwise "
          ...
          (let ([vector (list->vector elts)])
            (or (= (vector-length vector) size)
                (error (string-append "array: an array of shape "
                         (array:shape-vector->string (array:vector shape))
                         " has " (number->string size) " elements but got "
                         (number->string (vector-length vector))
                         " values: " (array:list->string elts))))
            (array:make
              vector
              (if (= size 0)
                  (array:optimize-empty (vector-ref (array:shape shape) 1))
        ...
        (let ([subsize (array:size subshape)])
          (or (array:good-share?
              ...
              (error (string-append "share-array: subshape "
                       (array:shape-vector->string (array:vector subshape))
                       " does not map into supershape "
                       (array:shape-vector->string (array:shape array))
                       " under mapping "
                       (array:map->string
                         f
      ...
      (define (array:optimize/vector f v)
        (let ([r (vector-length v)])
          (do ([k 0 (+ k 1)]) ((= k r)) (vector-set! v k 0))
          (let ([n0 (f v)]
                [cs (make-vector (+ r 1))]
      ...
      (define (array:optimize/actor f a)
        (let ([r (array-end a 0)]
          ...
          (let ([n0 (f a)]
            ...
            (let wok ([k 0])
              (if (< k r)
                  (let ([k1 (+ k 1)] [t (array:actor-index i k)])
                    (vector-set! v t 1)
                    (let ([nk (- (f a) n0)])
                      (vector-set! v t 0)
                      (vector-set! cs k1 nk)
        ...
        (let ([idx (array:index shape)]
          ...
          (do ([k 0 (+ k 1)]
               [s 1 (* s
                       (- (vector-ref
                            shv
                            (array:shape-vector-index idx k 1))
                          (vector-ref
                            shv
                            (array:shape-vector-index idx k 0))))])
              ((= k rnk) s))))
      (define (array:make-index shape)
        (let ([idx (array:index shape)]
              [shv (array:vector shape)]
              [rnk (vector-ref (array:shape shape) 1)])
          (do ([f (lambda () 0) (lambda (k . ks)
                                  (+ (* s
                                        (- k
                                           (vector-ref
                                             shv
      ...
      (define (array:good-share? subshape subsize f super)
        (or (zero? subsize)
            (letrec ([sub (array:vector subshape)]
              ...
              (let ([rnk (vector-ref (array:shape subshape) 1)])
                (or (array:unchecked-share-depth? rnk) (ck rnk '()))))))
      (define (array:unchecked-share-depth? rank)
        (if (> rank 10)
            (begin
              (display
                `(warning: unchecked depth in share: ,rank subdimensions))
              (newline)
              #t)
            #f))
      ...
      (define (array:good-indices? ks shv)
        (let ([d2 (vector-length shv)])
          (do ([kp ks (if (pair? kp) (cdr kp))]
               [k 0 (+ k 2)]
               [true #t (and true
                             (pair? kp)
                             (array:good-index? (car kp) shv k))])
              ((= k d2) (and true (null? kp))))))
      (define (array:good-indices.o? ks.o shv)
        (let ([d2 (vector-length shv)])
          (do ([kp ks.o (if (pair? kp) (cdr kp))]
               [k 0 (+ k 2)]
               [true #t (and true
                             (pair? kp)
                             (array:good-index? (car kp) shv k))])
              ((= k d2) (and true (pair? kp) (null? (cdr kp)))))))
      ...
      (define (array:good-index-actor? r v i shv)
        (and (= (* 2 r) (vector-length shv))
             (do ([j 0 (+ j 1)]
                  ...
                  [true #t (and true
                                (array:good-index?
                                  (vector-ref v (array:actor-index i j))
                                  shv
                                  k))])
                 ((= j r) true))))
      ...
      (define (array:not-in who ks shv)
        (let ([index (array:list->string ks)]
          ...
          (error (string-append who ": index " index " not in bounds "
                   bounds))))
      (define (array:list->string ks)
        (do ([index "" (string-append
                         index
                         (array:thing->string (car ks))
                         " ")]
             [ks ks (cdr ks)])
            ((null? ks) index)))
      (define (array:shape-vector->string shv)
        (do ([bounds "" (string-append bounds "[" (number->string (vector-ref shv t))
      ...
      (define (array:thing->string thing)
        (cond
          ...
          [(symbol? thing)
           (string-append "#<symbol>" (symbol->string thing))]
          [(char? thing) "#<char>"]
          [(string? thing) "#<string>"]
          [(list? thing)
           (string-append
             "#"
             (number->string (length thing))
             "<list>")]
          [(pair? thing) "#<pair>"]
          [(array? thing) "#<array>"]
          [(vector? thing)
           (string-append
             "#"
             (number->string (vector-length thing))
             "<vector>")]
          ...
          (do ([i "" (string-append i c "k" (number->string k))]
              ...
              ((< r k)
               (do ([o "" (string-append
                            o
                            c
                            (array:map-column->string m r k))]
                    [c "" ", "]
                    [k 0 (+ k 1)])
                   ((= k s) (string-append i " => " o)))))))
      (define (array:map-column->string m r k)
        (let ([v (array:vector m)] [i (array:index m)])
          (let ([n0 (vector-ref v (array:vector-index i (list 0 k)))])
            (let wok ([j 1] [e (if (= n0 0) "" (number->string n0))])
              (if (<= j r)
                  (let ([nj (vector-ref
                              v
                              (array:vector-index i (list j k)))])
                    (if (= nj 0)
                        (wok (+ j 1) e)
                        (let* ([nj (if (= nj 1)
                                       ""
                          ...
                          (if (string=? e "")
                              (wok (+ j 1) njkj)
                              (wok (+ j 1)
                                   (string-append e " + " njkj))))))
                  (if (string=? e "") "0" e))))))
      (define (array:grok/arguments proc r)
        (array:grok/index!
          (lambda (vec)
            (call-with-values
              (lambda () (array:apply-to-vector r proc vec))
              vector))
          (make-vector r)))
      (define (array:grok/index! proc in)
        (let ([m (array:index-length in)])
          (do ([k 0 (+ k 1)]) ((= k m)) (array:index-set! in k 0))
          (let* ([n0 (proc in)] [n (array:index-length n0)])
                ...
                (let ([nj (proc in)])
                  ...
                  (do ([k 0 (+ k 1)])
                    ...
                    (array-set!
                      ...
                      (+ j 1)
                      k
                      (- (array:index-ref nj k) (array:index-ref n0 k))))))
              arr)))))))
