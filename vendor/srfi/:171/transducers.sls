...
(library (srfi :171 transducers)
  (export rcons reverse-rcons rcount rany revery list-transduce
   ...
   port-transduce generator-transduce compose tmap tfilter
   tremove treplace tfilter-map tdrop tdrop-while ttake
   ttake-while tconcatenate tappend-map tdelete-neighbor-dupes
   tdelete-duplicates tflatten tsegment tpartition tinterpose
   tlog tenumerate)
  (import
