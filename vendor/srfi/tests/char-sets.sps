...
;;;;;; File header: ./tests/char-sets.sps
;; -*- mode: scheme; coding: utf-8 -*-
;; Copyright © 2018 Göran Weinholt <goran@weinholt.se>
;; SPDX-License-Identifier: (MIT OR BSD-3-Clause OR LicenseRef-LICENSE)
#!r6rs
;;;;;; File header: %3a14/char-sets/inversion-list-check.scm
; Part of Scheme 48 1.9.  See file COPYING for notices and license.
;;;;;; File header: %3a14/srfi-14-check.scm
; Part of Scheme 48 1.9.  See file COPYING for notices and license.
(import (rnrs) (srfi :14 char-sets inversion-list)
  (srfi :14 char-sets) (srfi :48 intermediate-format-strings)
  (srfi private include))
(define-syntax define-test-suite
  (syntax-rules () [(_ suite) (define dummy 'suite)]))
(define-syntax define-test-case
  (syntax-rules ()
    [(_ test-case suite checks ...) (begin checks ...)]))
(define (is-true) (lambda (x) x))
(define (is-false) not)
(define-syntax check
  (syntax-rules (=>)
    [(_ expr) (check-that expr (is-true))]
    [(_ expr => expect)
...
(begin
  ...
  (define-test-case creation/membership inversion-lists-tests
    ...
    (check
      (inversion-list-member?
        5
        (number->inversion-list 0 1000 5)))
    (check-that
    ...
    (check-that
      (inversion-list-member?
        6
        (range->inversion-list 0 1000 500 1000))
      (is-false))
    (check-that
      (inversion-list-member?
        499
  ...
  (define-test-case
    ...
    (check-that
      ...
      (is inversion-list=? (range->inversion-list 0 1000 5 10))))
  (define-test-case
    complement/2
    inversion-lists-tests
    (check-that
  ...
  (define-test-case
    ...
    (check-that
      ...
      (is inversion-list=? (range->inversion-list 0 1000 5 15))))
  (define-test-case
    union/4
    inversion-lists-tests
    (check-that
  ...
  (define-test-case
    ...
    (check-that
      (inversion-list-intersection
        (range->inversion-list 0 1000 5 10)
        (range->inversion-list 0 1000 20 30))
      (is inversion-list=? (make-empty-inversion-list 0 1000))))
  (define-test-case
    intersection/2
    inversion-lists-tests
    (check-that
      (inversion-list-intersection
        (range->inversion-list 0 1000 5 10)
        (range->inversion-list 0 1000 7 8))
      (is inversion-list=? (range->inversion-list 0 1000 7 8))))
  (define-test-case
    intersection/3
    inversion-lists-tests
    (check-that
      (inversion-list-intersection
        (range->inversion-list 0 1000 5 10)
        (range->inversion-list 0 1000 7 15))
      (is inversion-list=? (range->inversion-list 0 1000 7 10))))
  (define-test-case
    intersection/4
    inversion-lists-tests
    (check-that
  ...
  (define-test-case
    ...
    (check-that
      (inversion-list-remove
        (range->inversion-list 0 1000 0 1000)
        999)
      (is inversion-list=? (range->inversion-list 0 1000 0 999))))
  (define-test-case
    size
    inversion-lists-tests
    (check
      (inversion-list-size
        (ranges->inversion-list 0 1000 '(5 . 10) '(15 . 20)
          '(500 . 1000)))
      =>
      510))
  (define-test-case
  ...
  (define-test-case
    ...
    (check
      (inversion-list-fold/done?
        (lambda (n sum) (+ n sum))
        0
        (lambda (sum) (> sum 250000))
        (ranges->inversion-list 0 1000 '(5 . 10) '(15 . 20)
          '(500 . 1000)))
      =>
      250781))
  (define (i-list-sum i-list)
    (let loop ([cursor (inversion-list-cursor i-list)] [sum 0])
      (if (inversion-list-cursor-at-end? cursor)
          sum
          (loop
            (inversion-list-cursor-next i-list cursor)
            (+ (inversion-list-cursor-ref cursor) sum)))))
  (define-test-case
    cursor
    inversion-lists-tests
    (check
  ...
  (define-test-case
    ...
    (check-that
      ...
      (opposite
        (is =
            (inversion-list-hash
              (ranges->inversion-list 0 1000 '(5 . 10) '(500 . 1000))
              1031))))))
(begin
  ...
  (define-test-case char-set= srfi-14-tests (check (char-set=))
  ...
  (define-test-case
    ...
    srfi-14-tests
    (check-that
      (char-set-hash char-set:graphic 100)
      (all-of
        (is (lambda (x) (>= x 0)))
        (is (lambda (x) (<= x 99))))))
  (define-test-case
  ...
  (define-test-case
    ...
    (check-that
      ...
      (is char-set= (string->char-set "eiaou246801357999"))))
  (define-test-case
    char-set-unfold!
    srfi-14-tests
    (check-that
      (char-set-unfold! null? car cdr '(#\a #\e #\i #\o #\u)
        (string->char-set "0123456789"))
      (opposite
        (is char-set= (string->char-set "eiaou246801357")))))
  (define-test-case
    char-set-for-each
    srfi-14-tests
    ...
    (let ([cs (string->char-set "0123456789")])
      ...
      (check-that
        cs
        (opposite (is char-set= (string->char-set "7531"))))))
  (define-test-case
    char-set-map
    srfi-14-tests
    (check-that
      (char-set-map char-upcase (string->char-set "aeiou"))
      (is char-set= (string->char-set "IOUAEEEE")))
    (check-that
      (char-set-map char-upcase (string->char-set "aeiou"))
      (opposite (is char-set= (string->char-set "OUAEEEE")))))
  (define-test-case
    char-set-copy
    srfi-14-tests
    (check-that
  ...
  (define-test-case
    ...
    (check-that
      (char-set #\x #\y)
      (is char-set= (string->char-set "xy")))
    (check-that
      (char-set #\x #\y #\z)
      (opposite (is char-set= (string->char-set "xy")))))
  (define-test-case list->char-set srfi-14-tests
    ...
    (check-that
      (list->char-set '(#\x #\y))
      (opposite (is char-set= (string->char-set "axy"))))
    (check-that
  ...
  (define-test-case x->char-set srfi-14-tests
    (check-that
      (x->char-set #\x)
      (is char-set= (x->char-set "x")))
    (check-that
      (x->char-set #\x)
      (is char-set= (x->char-set (char-set #\x))))
    (check-that
      (x->char-set "y")
  ...
  (define-test-case
    ...
    srfi-14-tests
    (check-that
      (char-set-delete (x->char-set "123") #\2 #\a #\2)
  ...
  (define-test-case
    ...
    (check-that
      (char-set-intersection!
        (char-set-complement! (x->char-set "0123456789"))
        char-set:hex-digit)
      (is char-set= (x->char-set "abcdefABCDEF"))))
  (define-test-case
    char-set-union
  ...
  (define-test-case
    ...
    (check-that
      (char-set-difference
        (x->char-set "abcdefghijklmn")
        char-set:hex-digit)
      (is char-set= (x->char-set "ghijklmn"))))
  (define-test-case
    char-set-difference!
    srfi-14-tests
    (check-that
  ...
  (define-test-case
    ...
    srfi-14-tests
    (check-that
      (char-set-xor (x->char-set "0123456789") char-set:hex-digit)
      (is char-set= (x->char-set "abcdefABCDEF"))))
  (define-test-case
    char-set-xor!
    srfi-14-tests
  ...
  (define-test-case char-set:lower-case srfi-14-tests
    ...
    (check
      (char-set-contains?
        char-set:lower-case
        (scalar-value->char 224)))
    (check
      (not (char-set-contains?
             char-set:lower-case
             (scalar-value->char 194))))
    (check
      (char-set-contains?
        char-set:lower-case
        (scalar-value->char 181))))
  ...
  (define-test-case char-set:title-case srfi-14-tests
    (check
      (char-set-contains?
        char-set:title-case
        (scalar-value->char 453)))
    (check
      (char-set-contains?
        char-set:title-case
        (scalar-value->char 8104)))
  ...
  (define-test-case char-set:letter srfi-14-tests
    ...
    (check
      (char-set-contains?
        char-set:letter
        (scalar-value->char 170)))
    (check
      (char-set-contains?
        char-set:letter
        (scalar-value->char 186))))
  (define-test-case
    char-set:lower-case/2
    srfi-14-tests
    (check
      (not (char-set-every
             (lambda (c) (char-set-contains? char-set:lower-case c))
             char-set:letter)))
    (check
      (char-set-any
        (lambda (c) (char-set-contains? char-set:lower-case c))
  ...
  (define-test-case
    ...
    (check
      (not (char-set-every
             (lambda (c) (char-set-contains? char-set:upper-case c))
             char-set:letter)))
    (check
      (char-set-any
        (lambda (c) (char-set-contains? char-set:upper-case c))
  ...
  (define-test-case char-set:letter/2 srfi-14-tests
    ...
    (check
      (not (char-set-every
             (lambda (c) (char-set-contains? char-set:digit c))
             char-set:letter+digit)))
    (check
      (char-set-any
        (lambda (c) (char-set-contains? char-set:letter c))
  ...
  (define-test-case
    ...
    (check
      (char-set-every
        (lambda (c) (char-set-contains? char-set:letter+digit c))
        char-set:letter))
    (check
      (char-set-every
        (lambda (c) (char-set-contains? char-set:letter+digit c))
  ...
  (define-test-case char-set<=/2 srfi-14-tests
    ...
    (check
      (not (char-set<= char-set:printing char-set:graphic)))
    (check
      (char-set<=
        char-set:graphic
        char-set:printing
      ...
      (list->char-set
        (let loop ([c (char-set-cursor char-set:digit)] [l '()])
          (if (end-of-char-set? c)
              l
              (loop
                (char-set-cursor-next char-set:digit c)
  ...
  (define-test-case
    ...
    (check-that
      (char-set-unfold (lambda (x) (= x 20)) scalar-value->char
        add1 10 (char-set (scalar-value->char 20)))
      (is char-set= (ucs-range->char-set 10 21))))
  (define-test-case
    char-set-unfold!/2
    srfi-14-tests
    (check-that
      (char-set-unfold! (lambda (x) (= x 20)) scalar-value->char
        add1 10 (char-set-copy char-set:empty))
      (is char-set= (ucs-range->char-set 10 20))))
  (define-test-case
    char-set-for-each/2
    srfi-14-tests
    (check-that
      (let ([cs char-set:empty])
        (char-set-for-each
          (lambda (c) (set! cs (char-set-adjoin cs c)))
          char-set:digit)
        cs)
      (is char-set= char-set:digit)))
  (define-test-case char-set-map/2 srfi-14-tests equal?
    (check-that
      (char-set-map (lambda (c) c) char-set:digit)
      (is char-set= char-set:digit))
    (check-that
      (char-set-map (lambda (c) c) char-set:digit)
      (is char-set= char-set:digit))
  ...
  (define-test-case
    ...
    (let ([abc (char-set #\a #\b #\c)])
      (check-that (char-set #\c #\a #\b) (is char-set= abc))
      (check-that (string->char-set "cba") (is char-set= abc))
      (check-that
        (string->char-set! "cba" (char-set-copy char-set:empty))
        (is char-set= abc))
      (check-that
        (string->char-set "cb" (char-set #\a))
        (is char-set= abc))
      (check-that
        (char-set-filter (lambda (c) (char=? c #\b)) abc)
      ...
      (check-that
        (x->char-set #\a)
        (is char-set= (char-set #\a)))))
  (define-test-case ucs-range->char/2 srfi-14-tests
    (check-that
      (char-set-union
        (ucs-range->char-set 0 55296)
        (ucs-range->char-set 57344 131072))
      (is char-set= (ucs-range->char-set 0 131072)))
    (check-that
      (ucs-range->char-set 0 55296)
      (is char-set= (ucs-range->char-set 0 55297)))
    (check-that
      (ucs-range->char-set 0 55296)
      (is char-set= (ucs-range->char-set 0 57343)))
    (check-that
      char-set:empty
      (is char-set= (ucs-range->char-set 55296 55312)))
    (check-that
      char-set:empty
      (is char-set= (ucs-range->char-set 55312 57344)))
    (check-that
      (ucs-range->char-set 55312 57345)
      (is char-set= (ucs-range->char-set 57344 57345)))
    (check-that
      (char-set
        (scalar-value->char 55295)
        (scalar-value->char 57344))
      (is char-set= (ucs-range->char-set 55295 57345))))
  (define-test-case
    char-set-count/2
    srfi-14-tests
    (check
      (char-set-count
        (lambda (x) (and (char<=? #\0 x) (char<=? x #\2)))
        char-set:digit)
      =>
      3))
  (define-test-case list->char-set/2 srfi-14-tests
    (check-that
      (list->char-set (char-set->list char-set:digit))
      (is char-set= char-set:digit))
    (check-that
      (list->char-set
    ...
    (check-that
      ...
      (is char-set= char-set:digit))
    (check-that
      (string->char-set (char-set->string char-set:digit))
      (is char-set= char-set:digit))))
