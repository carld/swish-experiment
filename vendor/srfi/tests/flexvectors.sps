...
;;;;;; File header: ./tests/flexvectors.sps
#!r6rs
(import (srfi :214) (srfi :64) (rnrs))
(test-begin "flexvectors")
(test-equal "flexvector?" #t (flexvector? (flexvector)))
(test-equal
  "flexvector-empty?"
  #t
  (flexvector-empty? (flexvector)))
(test-equal
  "flexvector-empty? non-empty"
  #f
  (flexvector-empty? (flexvector 1)))
(test-equal
  "flexvector-length"
  3
  (flexvector-length (make-flexvector 3 #f)))
(test-equal
  "flexvector"
  3
...
(let ([fv (flexvector 'a 'b 'c)])
  ...
  (test-equal
    "flexvector-set! return"
    'b
    (flexvector-set! fv 1 'd))
  (test-equal
    "flexvector-set! mutate"
    'd
    (flexvector-ref fv 1))
  (test-equal
    "flexvector-add-back! return"
    fv
    (flexvector-add-back! fv 'e))
  (test-equal
    "flexvector-add-back! mutate"
    '(4 . e)
    (cons
      (flexvector-length fv)
      (flexvector-ref fv (- (flexvector-length fv) 1))))
  (test-equal
    "flexvector-remove! return"
    'd
    (flexvector-remove! fv 1))
  (test-equal
    "flexvector-remove! mutate"
    '(3 . c)
    (cons (flexvector-length fv) (flexvector-ref fv 1)))
  (test-equal
    "flexvector-clear! return"
    fv
    (flexvector-clear! fv))
  (test-equal
    "flexvector-clear! mutate"
    0
    (flexvector-length fv)))
(test-equal
  "flexvector=? same symbols"
  #t
  (flexvector=? eq? (flexvector 'a 'b) (flexvector 'a 'b)))
(test-equal
  "flexvector=? different symbols"
  #f
  (flexvector=? eq? (flexvector 'a 'b) (flexvector 'b 'a)))
(test-equal
  "flexvector=? different lengths"
  #f
  (flexvector=?
    =
    ...
    (flexvector 1 2 3 4)))
(test-equal
  "flexvector=? same numbers"
  #t
  (flexvector=? = (flexvector 1 2 3 4) (flexvector 1 2 3 4)))
(test-equal
  "flexvector=? 0 arguments"
  #t
  (flexvector=? eq?))
(test-equal
  "flexvector=? 1 argument"
  #t
  (flexvector=? eq? (flexvector 'a)))
(test-equal
  "make-flexvector"
  '#(a a a)
  (flexvector->vector (make-flexvector 3 'a)))
(test-equal
  "flexvector-unfold"
...
(test-equal
  "flexvector->string"
  "abc"
  (flexvector->string (flexvector #\a #\b #\c)))
...
(let ([fv (flexvector 10 20 30)])
  ...
  (test-equal
    "flexvector-copy start"
    '#(20 30)
    (flexvector->vector (flexvector-copy fv 1)))
  (test-equal
    "flexvector-copy start end"
    '#(20)
  ...
  (test-equal
    ...
    (flexvector->vector
      (flexvector-append-map
        (lambda (x) (flexvector x (* x 10)))
        fv)))
  (test-equal
    "flexvector-append-map/index"
    '#(0 10 10 1 20 22 2 30 34)
    (flexvector->vector
      (flexvector-append-map/index
  ...
  (test-equal
    ...
    '#(10)
    (flexvector->vector
      (flexvector-filter (lambda (x) (< x 15)) fv)))
  (test-equal
  ...
  (test-equal
    ...
    '(#t . #f)
    (cons
      (flexvector-any (lambda (x) (= x 20)) fv)
      (flexvector-any (lambda (x) (= x 21)) fv)))
  (test-equal
    "flexvector-every"
    '(#t . #f)
    (cons
      (flexvector-every (lambda (x) (< x 40)) fv)
...
(let ([fv (flexvector #\a #\b #\c #\d #\e #\f #\g #\h #\i
            #\j)]
  ...
  (test-equal
    "flexvector-binary-search first"
    0
    (flexvector-binary-search fv #\a cmp))
  (test-equal
    "flexvector-binary-search last"
    9
    (flexvector-binary-search fv #\j cmp))
  (test-equal
    "flexvector-binary-search not found"
    #f
    (flexvector-binary-search fv #\k cmp))
  (test-equal
    "flexvector-binary-search in range"
    5
    (flexvector-binary-search fv #\f cmp 2 6))
  (test-equal
    "flexvector-binary-search out of range"
    #f
...
(test-equal
  ...
  '#(a b h i)
  (flexvector->vector
    (flexvector-append-subvectors (flexvector 'a 'b 'c 'd 'e) 0
      2 (flexvector 'f 'g 'h 'i 'j) 2 4)))
...
(test-equal
  "flexvector-add! empty"
  '#(foo)
  (mutate-as x '#() (flexvector-add! x 0 'foo)))
(test-equal
  "flexvector-add! empty multiple"
  '#(foo bar baz)
  (mutate-as x '#() (flexvector-add! x 0 'foo 'bar 'baz)))
(test-equal
  "flexvector-add! start"
  '#(foo bar baz)
  (mutate-as x '#(bar baz) (flexvector-add! x 0 'foo)))
(test-equal
  "flexvector-add! start multiple"
  '#(foo bar baz qux quux)
  (mutate-as
    x
    '#(qux quux)
    (flexvector-add! x 0 'foo 'bar 'baz)))
(test-equal
  "flexvector-add! middle"
  '#(foo bar baz)
  (mutate-as x '#(foo baz) (flexvector-add! x 1 'bar)))
(test-equal
  "flexvector-add! middle multiple"
  '#(foo bar baz qux quux)
  (mutate-as
    x
    '#(foo quux)
    (flexvector-add! x 1 'bar 'baz 'qux)))
(test-equal
  "flexvector-add! end"
  '#(foo bar baz)
  (mutate-as x '#(foo bar) (flexvector-add! x 2 'baz)))
(test-equal
  "flexvector-add! end multiple"
  '#(foo bar baz qux quux)
  (mutate-as
    x
    '#(foo bar)
    (flexvector-add! x 2 'baz 'qux 'quux)))
(test-equal
  "flexvector-add-all!"
  '#(foo bar baz qux)
  (mutate-as
    x
    '#(foo qux)
    (flexvector-add-all! x 1 '(bar baz))))
(test-equal
  "flexvector-add-front! empty"
  '#(foo)
  (mutate-as x '#() (flexvector-add-front! x 'foo)))
(test-equal
  "flexvector-add-front! empty multiple"
  '#(foo bar baz)
...
(test-equal
  "flexvector-add-front! multiple"
  '#(foo bar baz qux quux)
  (mutate-as
    x
    '#(qux quux)
    (flexvector-add-front! x 'foo 'bar 'baz)))
(test-equal
  "flexvector-add-back! empty"
  '#(foo)
  (mutate-as x '#() (flexvector-add-back! x 'foo)))
(test-equal
  "flexvector-add-back! empty multiple"
  '#(foo bar baz)
...
(test-equal
  "flexvector-add-back! multiple"
  '#(foo bar baz qux quux)
  (mutate-as
    x
    '#(foo bar)
    (flexvector-add-back! x 'baz 'qux 'quux)))
(test-equal
  "flexvector-append!"
  '#(foo bar baz qux)
  (mutate-as
    x
    '#(foo bar)
    (flexvector-append! x (flexvector 'baz 'qux))))
(test-equal
  "flexvector-append! multiple"
  '#(foo bar baz qux quux)
  (mutate-as
    x
    '#(foo bar)
...
(test-equal
  ...
  (mutate-as
    x
    '#(a b c d e f)
    (flexvector-remove-range! x 1 4)))
(test-equal
  "flexvector-remove-range! empty range"
  '#(a b c d e f)
  (mutate-as
    x
    '#(a b c d e f)
    (flexvector-remove-range! x 1 1)))
(test-equal
  "flexvector-remove-range! overflow left"
  '#(e f)
  (mutate-as
    x
    '#(a b c d e f)
    (flexvector-remove-range! x -1 4)))
(test-equal
  "flexvector-remove-range! overflow right"
  '#(a b)
  (mutate-as
    x
    '#(a b c d e f)
    (flexvector-remove-range! x 2 10)))
(test-equal
  "flexvector-map!"
  '#(100 200 300)
  (mutate-as
...
(test-equal
  ...
  (mutate-as
    fv
    '#(1 2 3 4 5)
    (flexvector-copy! fv 1 (flexvector 20 30 40))))
(test-equal
  "flexvector-copy! bounded"
  '#(1 20 30 40 5)
  (mutate-as
    fv
    '#(1 2 3 4 5)
    (flexvector-copy! fv 1 (flexvector 10 20 30 40 50) 1 4)))
(test-equal
  "flexvector-copy! overflow"
  '#(1 2 30 40 50)
  (mutate-as
    fv
    '#(1 2 3)
    (flexvector-copy! fv 2 (flexvector 30 40 50))))
(test-equal
  "flexvector-reverse-copy!"
  '#(1 40 30 20 5)
  (mutate-as
    fv
    '#(1 2 3 4 5)
    (flexvector-reverse-copy! fv 1 (flexvector 20 30 40))))
(test-equal
  "flexvector-reverse-copy! bounded"
  '#(1 40 30 20 5)
  (mutate-as
    fv
    '#(1 2 3 4 5)
    (flexvector-reverse-copy! fv 1 (flexvector 10 20 30 40 50) 1
      4)))
(test-equal
  "flexvector-reverse-copy! overflow"
  '#(1 2 50 40 30)
  (mutate-as
    fv
    '#(1 2 3)
    (flexvector-reverse-copy! fv 2 (flexvector 30 40 50))))
(test-equal
  "flexvector-fill!"
  '#(foo foo foo)
  (mutate-as x '#(1 2 3) (flexvector-fill! x 'foo)))
(test-equal
  "flexvector-fill! start"
  '#(1 2 bar bar bar)
  (mutate-as x '#(1 2 3 4 5) (flexvector-fill! x 'bar 2)))
(test-equal
  "flexvector-fill! start end"
  '#(1 2 baz baz 5)
  (mutate-as x '#(1 2 3 4 5) (flexvector-fill! x 'baz 2 4)))
(test-equal
  "flexvector-fill! clamped"
  '#(qux qux qux)
